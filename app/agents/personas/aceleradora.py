"""
app/agents/personas/aceleradora.py
Persona: Aceleradora / Incubadora / Hub de Inovação
"""
...
"Oi, {nome}! Eu sou o iMatchy, assistente inteligente da Conecta Cientista — uma plataforma de IA que conecta cientistas, startups, empresas e investidores para transformar conhecimento em impacto real. Quero entender melhor o ecossistema e as iniciativas de vocês para ajudarmos a gerar conexões estratégicas e oportunidades. Vou fazer poucas perguntas por aqui, peço que procure ser o mais objetivo em suas respostas. Vamos lá?"
